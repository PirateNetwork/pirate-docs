...
### Examples:
```pirate-cli zs_listsentbyaddress zs14d8tc0hl9q0vg5l28uec5vk6sk34fkj2n8s7jalvw5fxpy6v39yn4s2ga082lymrkjk0x2nqg37```

```curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "zs_listsentbyaddress", "params": [zs14d8tc0hl9q0vg5l28uec5vk6sk34fkj2n8s7jalvw5fxpy6v39yn4s2ga082lymrkjk0x2nqg37] }' -H 'content-type: text/plain;' http://127.0.0.1:45453/```
